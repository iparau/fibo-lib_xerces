/* src/xercesc/util/Xerces_autoconf_config_unix.hpp.  Generated from Xerces_autoconf_config.hpp.in by configure.  */
/*
...
#ifndef XERCES_AUTOCONFIG_CONFIG_UNIX_HPP
#define XERCES_AUTOCONFIG_CONFIG_UNIX_HPP
